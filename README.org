...
Pay attention to the keys registered in the [[https://github.com/tarsius/keycast][keycast]] log buffer to the left.

+ Selecting the 10th candidate in a ~find-file~ completion. Keys: ~1 0~, note that
  no ~RET~ is pressed for confirmation.

#+caption:  Selecting the 10th candidate in a completion
#+attr_latex: :width 0.55\linewidth
#+attr_html: :style width:55% :alt Demonstration of a rapid completion
[[file:screencasts/vertico-timer-basic-2025-11-18-15:33:48.gif]]
...
#+attr_latex: :width 0.55\linewidth
#+attr_html: :style width:55% :alt Demonstration of an embark-act action
[[file:screencasts/vertico-timer-act-2025-11-18-15:41:39.gif]]
...
This package concerns itself with more [[id:02bcd4b7-4815-4e2a-96c4-af2c12a805ee][bells and whistles]] but really this covers
...
over to the minimal [[id:79a72d25-a6a6-47ff-ba24-29d5a955f194][configuration]] after [[id:81665f01-3b3e-40b7-9b83-14b5f1fff2b5][installation]] and get a feel for the
...
if you define single keys to [[id:02bcd4b7-4815-4e2a-96c4-af2c12a805ee][change the action]] performed on a target.
...
* Installation
:PROPERTIES:
:ID:       81665f01-3b3e-40b7-9b83-14b5f1fff2b5
:END:
...
(use-package
  :straight (vertico-timer :type git :host github :repo "ventruvian/vertico-timer"))
#+end_src
...
* Configuration
:PROPERTIES:
:ID:       79a72d25-a6a6-47ff-ba24-29d5a955f194
:END:
...
A more advanced configuration utilizing changes to the [[id:02bcd4b7-4815-4e2a-96c4-af2c12a805ee][exit action]]:
...
(use-package vertico-timer
  ...
  :config
  ;; Activate the action hint in the minibuffer
...
:PROPERTIES:
:ID:       02bcd4b7-4815-4e2a-96c4-af2c12a805ee
:END:
...
Here is a little comparison of keypresses between [[id:79a72d25-a6a6-47ff-ba24-29d5a955f194][this]] configuration of
...
** Preparing an Action
:PROPERTIES:
:ID:       b4da6be3-9dcd-4ccc-960b-5a7cfbf46591
:END:
...
- vertico-map :: For all commands that [[id:b4da6be3-9dcd-4ccc-960b-5a7cfbf46591][prepare an action]] as well as for the session-toggle.
  This package doesn't bind to ~vertico-map~ on it's own but you [[id:79a72d25-a6a6-47ff-ba24-29d5a955f194][are suggested]] to
